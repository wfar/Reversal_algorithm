...
class Rev_TF:
    ...
    def write_to_file(self, name, frame, time, group):
        ...
        path = os.getcwd()                              # path to new data set folder
        #print(path)
    ...
    def run(self):
        ...
        files = os.listdir(os.getcwd() + '\\full_data_2fps_next')                            # get all files in the directory
        print(files)
        for file in files:                                                              # iterate through each file                                                
            print(file)
            name = file[4:]                                                             # save file name
       
            with open(os.getcwd() + '\\full_data_2fps_next\\' + file, 'r') as cf:            # open current file in loop
                print("Opened!")
